...
<head>
  ...
  <style>
    ...
    .topbar .logo { color: #fff; margin: 0; font-size: 1.1rem; }
    .topbar .logo span { color: #cfe7d8; }
    .topbar a { color: #d7ece0; text-decoration: none; font-weight: 600; font-size: 0.9rem; }

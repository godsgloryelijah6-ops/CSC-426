...
2. A web  authentication app built with HTML, CSS, JavaScript and PHP.

**Live my website app:** https://godsglory.gt.tc/
...
│   ├── myCalculator.py
│   └── README.md
└── my website/             PHP my website authentication app (hosted online)
    ├── index.html
    ├── style.css
    ├── script.js
    ├── login.php
...
## 2. my website app (hosted online)

A my website screen with username and password fields, a my website button and a reset button. Input is validated in the browser and again on the server, passwords are stored as bcrypt hashes, and a successful my website opens a dashboard page that is protected by a PHP session.

### Where it is and how to reach it

The app is live and hosted here:

**https://godsglory.gt.tc/**
...
Deployment notes and the full feature list are in `my website/README.md`.
